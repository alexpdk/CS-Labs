...
namespace DrugAccount {
	...
	public interface IFund	{
		...
		bool provideFunding(IShipment<IDrug> shipment, IDepartment department);
	}
	/// <summary>
	...
	public class Fund : IFund {
		...
		public virtual bool provideFunding(IShipment<IDrug> shipment, IDepartment department) {
	...
	public class TargetedFund : Fund {
		...
		public override bool approveFunding(IDrug drug, IDepartment department) {
			return targets.Exists(d=>d.Equals(drug));
		}
	}
	/// <summary>
